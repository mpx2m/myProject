...
window.onload = function() {
  ...
  drawMaze("/assets/img/maze.png", 268, 5);
...
document.getElementById("normal").addEventListener('click',loadHard,false)
document.getElementById("easy").addEventListener('click',loadEasy,false)
document.getElementById("hard").addEventListener('click',loadVeryHard,false)

function loadEasy() {
  drawMaze("/assets/img/easy_maze.png", 5, 5);
}
...
function loadVeryHard() {
  drawMaze("/assets/img/hard_maze.jpg", 578, 2);
}
